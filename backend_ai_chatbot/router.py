...
def register_routes(app):
            ...
            if file and allowed_file(file.filename):
                ...
                if file_type == 'text/csv':
                    ...
                    new_file = File(
                        ...
                        file_type=file_type,
                        file_data=file.read(),
                        user_id=user_id  # Read the file content (be cautious with large files)
                    )
    ...
    @jwt_required()
    def chat(embadding = embedding_path):
        if request.method == 'POST':
            print("hello")
            user_id = get_jwt_identity()  # Ensure that user_id is available in the request context
            ...
            if file_id:
                ...
                result_retrive = get_result(embadding, user_question=user_question)
